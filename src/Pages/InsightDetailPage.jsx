...
const InsightDetailPage = () => {
  ...
  const insight = insightsData.insights.find(i => i.id === insightId) || insightsData.insights[0];
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative py-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="absolute bottom-20 left-20 w-64 h-64 bg-purple-700/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        ...
        <div className={`max-w-4xl mx-auto relative z-10 transition-all duration-1000 ${
          ...
          {/* Category Badge */}
          <div className="mb-6">
            <span className="bg-purple-700 text-white text-sm font-semibold px-4 py-2 rounded-full uppercase tracking-wide">
              {insight.category}
            </span>
          </div>
          ...
          <p className="text-xl sm:text-2xl text-gray-300 mb-8 leading-relaxed">
            We invite experienced professionals, recent graduates, and students interested in learning more about McKinsey to attend.
          </p>
          ...
          <div className="flex items-center gap-6 text-gray-400 flex-wrap">
            ...
            <button 
              ...
              className="flex items-center gap-2 hover:text-purple-400 transition-colors duration-300 group ml-auto"
            >
      ...
      <div className="bg-white text-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className={`mb-12 transition-all duration-1000 delay-200 ${
            ...
            <div className="bg-gray-50 border-l-4 border-purple-700 p-6 sm:p-8 rounded-r-lg shadow-sm">
          ...
          {/* Article Body */}
          <article className={`transition-all duration-1000 delay-300 ${
            isVisible ? 'opacity-100' : 'opacity-0'
          }`}>
            {/* First Paragraph with Drop Cap */}
            <p className="text-lg leading-relaxed mb-6 text-gray-700">
              <span className="text-7xl float-left mr-4 mt-1 text-purple-700 font-serif leading-none">E</span>
            ...
            {insight.content.sections.map((section, index) => (
              <div key={index} className="mb-8">
                {section.heading && (
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4 mt-10">
                    {section.heading}
                  </h2>
                )}
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-2xl p-6 sm:p-8 lg:p-10 my-12 border border-purple-100 shadow-sm">
            ...
            {/* Editor Note */}
            <p className="text-sm text-gray-500 italic mt-8 border-t border-gray-200 pt-6">
          ...
          <div className={`mt-16 transition-all duration-1000 delay-500 ${
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {insightsData.insights
                .filter(i => i.id !== insight.id && !i.featured)
                .slice(0, 2)
                .map((relatedInsight) => (
                  <Link 
                  ...
                  >
                    <div className="group bg-gray-50 rounded-xl p-6 hover:bg-purple-50 hover:shadow-lg transition-all duration-300 border border-gray-200 hover:border-purple-300">
                      <span className="text-xs font-semibold text-purple-700 uppercase tracking-wide">
                        {relatedInsight.category}
                      </span>
                      <h4 className="text-xl font-bold text-gray-900 mt-3 mb-2 group-hover:text-purple-700 transition-colors line-clamp-2">
      ...
      <div className="bg-black py-16 px-4 sm:px-6 lg:px-8">
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 delay-600 ${
          ...
          <Link to="/insights" className="inline-block">
            <button className="bg-purple-700 hover:bg-purple-600 text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-700/50">
              View All Insights
            </button>
          </Link>
        </div>
      ...
      {showShareMenu && (
        ...
        >
          <div 
            className="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all duration-300 animate-scale-in"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="px-6 py-5 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-gray-900">Share this insight</h3>
                <button
                  onClick={() => setShowShareMenu(false)}
              ...
              <p className="text-sm text-gray-500 mt-1">Share "{insight.title}" with your network</p>
            </div>
            ...
            <div className="px-6 py-4">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6">
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 rounded-xl hover:bg-blue-50 transition-all duration-300 group border border-gray-200 hover:border-blue-300"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 rounded-xl hover:bg-blue-50 transition-all duration-300 group border border-gray-200 hover:border-blue-600"
                >
                ...
                <button
                  ...
                  className="flex flex-col items-center gap-2 p-4 rounded-xl hover:bg-blue-50 transition-all duration-300 group border border-gray-200 hover:border-blue-700"
                >
              ...
              <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    value={currentUrl}
                    readOnly
                    className="flex-1 px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-sm text-gray-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  />
                  <button
            ...
            <div className="px-6 py-4 bg-gray-50 rounded-b-2xl">
              <button
                onClick={() => setShowShareMenu(false)}
                className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-100 transition-colors"
              >
                Close
              </button>
            </div>
