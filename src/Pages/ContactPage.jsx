...
const handleSubmit = (e) => {
  ...
  const serviceId = 'service_hk3ce2k';
  const templateId = 'template_6v0kkir';
  const publicKey = 'le_8hFfmXsk6tcrQf';
...
{status && (
  <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 px-4">
    <div className={`max-w-md w-full ${
      status === 'success' 
        ? 'bg-gradient-to-br from-green-900/90 to-black border-green-600' 
