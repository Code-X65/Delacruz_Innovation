      ...
      <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="group relative bg-purple-700  overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    {/* Learn More Link */}
                    <Link to={service.link} className="flex items-center text-gray-50 transition-colors duration-300">
                ...
                {services.map((_, index) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all ${
                      index === currentCard ? 'bg-purple-500 w-8' : 'bg-gray-600'
                    }`}
        ...
        <div className="hidden md:grid grid-cols-3 gap-6 lg:gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className={`group relative bg-purple-700  overflow-hidden transition-all duration-500 transform ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
              style={{ 
